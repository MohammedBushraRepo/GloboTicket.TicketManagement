...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext : DbContext 
    {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(GloboTicketDbContext).Assembly); //this line to apply all configurations from assembly 
        ...
        {
            foreach (var entry in ChangeTracker.Entries<AuditableEntity>()) //track entites --- all entity classes inherite from this class for tracing and audit perposes
            {
                switch (entry.State)
                {
